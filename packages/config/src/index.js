...
const getApiUrl = (type = 'http') => {
  if (typeof window === 'undefined') {
    ...
    return type === 'http'
      ? exports.AppConfig.API.DEFAULT_HTTP_URL
      : exports.AppConfig.API.DEFAULT_WS_URL;
  }
...
const getUserActionRequired = category => {
  return exports.AppConfig.ERROR_HANDLING.CATEGORIES[category]
