...
exports.ErrorCategory = exports.failure = exports.success = exports.Failure = exports.Success = exports.DUR = exports.GameConfigHelpers = exports.GameConfig = void 0;
...
exports.GameConfigHelpers = {
     ...
     */
    secondsToMs: (seconds) => seconds * exports.GameConfig.TIMING.CONVERSIONS.SECONDS_TO_MS,
    /**
     * Convert minutes to milliseconds
     */
    minutesToMs: (minutes) => minutes * exports.GameConfig.TIMING.CONVERSIONS.MINUTES_TO_MS,
    /**
     * Convert minutes to seconds
     */
    minutesToSeconds: (minutes) => minutes * exports.GameConfig.TIMING.CONVERSIONS.MINUTES_TO_SECONDS,
    /**
     * Check if a room code is valid
     */
    isValidRoomCode: (code) => exports.GameConfig.VALIDATION.ROOM_CODE_PATTERN.test(code),
    /**
     * Check if a nickname is valid
     */
    isValidNickname: (nickname) => {
        const { MIN_NICKNAME_LENGTH, MAX_NICKNAME_LENGTH } = exports.GameConfig.RULES.PLAYERS;
...
class Failure {
    ...
    getOrThrow() {
        ...
        throw new Error(typeof this.error === 'string' ? this.error : 'Unknown error');
    }
}
