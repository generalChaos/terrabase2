-- Add age-appropriate styling guidance to logo generation prompt
UPDATE logo_prompts 
...
- U6-U8: ONLY playful, cute, friendly, fun designs (NO fierce, aggressive, intimidating elements)
- U10-U12: Mix of playful and slightly competitive (some bold OK, but keep it kid-friendly)
- U14+: Can include more competitive, bold, fierce elements
- ALWAYS prioritize kid-friendly over aggressive for younger ages
- Younger teams should have softer, rounder shapes and brighter, happier colors
- Older teams can have sharper, more angular designs and more serious color schemes
